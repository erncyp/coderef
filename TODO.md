...
- [ ] **Range refs** — mark a block with a start/end UUID pair (e.g. `ref:a3f9c821:start` / `ref:a3f9c821:end`) so an AI receives a whole logical unit, not just a line
...
- [ ] **Range ref support** — highlight and navigate ref ranges once range refs are implemented
